...
## Dependencies
Code in this repo depends on the very latest bits (not even in official previews). If you want to try it out, [grab the latest .NET 6 SDK installer](https://aka.ms/dotnet/6.0.1xx/daily/dotnet-sdk-win-x64.exe).
